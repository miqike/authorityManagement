...
<body style="margin: 5px;">
	...
	<div id="toobar1" class="easyui-toolbar">
		<a id="btnShowPlanListWindow" class="easyui-linkbutton"
			data-options="plain: true, iconCls: 'icon2 r5_c20'">选择计划列表</a> <a
			href="javascript:void(0);" id="btnGoFirst" class="easyui-linkbutton"
			iconCls="icon-first" plain="true">首</a> <a href="javascript:void(0);"
			id="btnGoPrev" class="easyui-linkbutton" iconCls="icon-previous"
			plain="true">上</a> <a href="javascript:void(0);" id="btnGoNext"
			class="easyui-linkbutton" iconCls="icon-next" plain="true">下</a> <a
			href="javascript:void(0);" id="btnGoLast" class="easyui-linkbutton"
			iconCls="icon-last" plain="true">末</a>
	...
	<div id="panel" class="easyui-layout" data-options="fit:true"
		...
		<div data-options="region:'west',split:true," title="单位列表"
			style="width: 240px;">
		...
		"
				...
				<thead>
					<tr>
						...
						<th data-options="field:'hcjgmc'" halign="center" align="left"
							width="150">任务下达机关</th>
						<th data-options="field:'qymc'" halign="center" align="left"
							width="100">管辖单位</th>
						<th data-options="field:'zfryCode1'" halign="center"
							align="center" width="100" formatter="formatZfry">检查人员</th>
						<th data-options="field:'djjgmc'" halign="center" align="left"
							width="150">登记(移出)机关</th>
						...
						<th data-options="field:'rlrmc'" halign="center" align="left"
							width="70">认领人</th>
						<th data-options="field:'rlrq'" halign="center" align="left"
							width="70" formatter="formatDate">认领日期</th>
						<th data-options="field:'clrq'" halign="center" align="left"
							width="70" formatter="formatDate">成立日期</th>
						<th data-options="field:'zs'" halign="center" align="left"
							width="100">住所</th>
						<th data-options="field:'jhwcrq'" halign="center" align="left"
							width="70" formatter="formatDate">计划完成</th>
						<th data-options="field:'sjwcrq'" halign="center" align="left"
							width="70" formatter="formatDate">实际完成</th>
					</tr>
				</thead>
			</table>
			...
			<div id="planGridToolbar">
             ...
             <a href="#" id="btnSort2" class="easyui-linkbutton" iconCls="icon2 r1_c13" plain="true"
              ...
              -->
				<a href="#" id="btnAccept" class="easyui-linkbutton"
					iconCls="icon2 r5_c10" plain="true" data-options="disabled:false">认领</a>
				<a href="#" id="btnUnAccept" class="easyui-linkbutton"
					iconCls="icon2 r5_c20" plain="true" data-options="disabled:false">取消认领</a>
				<input class="easyui-searchbox"
					data-options="width: 260, height: 24, prompt: '快速定位', searcher: quickSearch, menu:'#mm'" />
				<!-- 
             <a href="#" id="btnShowDetail" class="easyui-linkbutton" iconCls="icon2 r5_c10" plain="true"
                data-options="disabled:true">详细</a> -->
               
				<a id="btnDone" onClick="done()" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-search'">已认领</a>
		...
		<div id="panel" class="easyui-layout" data-options="fit:true"
			...
			<div data-options="region:'center',split:true" style="width: 340px;">
				<table id="grid1" class="easyui-datagrid"
					...
					toolbar="#gridToolbar1" sortOrder="asc">
					<thead>
						<tr>
							<th data-options="field:'nd'" halign="center" align="center"
								sortable="true" width="35">年度</th>
							<th data-options="field:'jhbh'" halign="center" align="left"
								sortable="true" width="70">计划编号</th>
							<th data-options="field:'gsjhbh'" halign="center" align="left"
								sortable="true" width="100">公示系统计划编号</th>
							<th data-options="field:'jhmc'" halign="center" align="center"
							...
							<th data-options="field:'planType'" halign="center"
								align="center" sortable="true" width="65" codeName="planType"
								formatter="formatCodeList">计划类型</th>
							<th data-options="field:'ksrq'" halign="center" align="center"
								sortable="true" width="80" formatter="formatDate">计划开始时间</th>
							<th data-options="field:'yqwcsj'" halign="center" align="center"
								sortable="true" width="80" formatter="formatDate">计划结束时间</th>
							<th data-options="field:'fl'" halign="center" align="center"
								sortable="true" width="60" codeName="hcfl"
								formatter="formatCodeList">检查分类</th>
							<th data-options="field:'nr'" halign="center" align="center"
								sortable="true" width="60" codeName="hcnr"
								formatter="formatCodeList">检查内容</th>
							<th data-options="field:'hcrwsl'" halign="center" align="right"
								sortable="true" width="45">任务数</th>
							<th data-options="field:'yrlsl'" halign="center" align="right"
								sortable="true" width="45">已认领</th>
							<th data-options="field:'wrlsl'" halign="center" align="right"
								sortable="true" width="45">未认领</th>
							<th data-options="field:'xdrq'" halign="center" align="center"
								sortable="true" width="70" formatter="formatDate">下达日期</th>
							<th data-options="field:'xdrmc'" halign="center" align="center"
								sortable="true" width="70">下达人</th>
							<th data-options="field:'sm'" halign="center" align="left"
								sortable="true" width="250">说明</th>
						</tr>
					</thead>
				</table>
				<div id="gridToolbar1">
	...
	<div id="importTaskWindow" class="easyui-window" title="导入任务信息"
		...
		<div id="file" style="margin: 10px; display: none">
			<input class="easyui-filebox" value="选择文件" style="width: 300px"
				data-options="buttonText:'选择文件'" /> <a href="javascript:void(0);"
				id="btnImportFile" class="easyui-linkbutton" iconCls="icon2 r6_c10"
				plain="true">导入</a>
		</div>


		<div id="dblink" style="margin: 10px;">
			<a href="javascript:void(0);" id="btnTestDblink"
				class="easyui-linkbutton" iconCls="icon2 r13_c20" plain="true">测试连接</a>
			<a href="javascript:void(0);" id="btnImportDblink"
				class="easyui-linkbutton" iconCls="icon2 r6_c10" plain="true">导入</a>
