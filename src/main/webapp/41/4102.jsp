    ...
    <!-- 
     ...
     <div data-options="region:'center'">
         ...
         <div id="grid2Toolbar">
			 ...
			 <a href="#" id="btnImportFinancial" class="easyui-linkbutton" iconCls="icon2 r1_c15" plain="true"
				data-options="disabled:false">财务电子数据导入</a>
			 <a href="#" id="btnImportSelfCheck" class="easyui-linkbutton" iconCls="icon2 r1_c15" plain="true"
...
<script type="text/javascript" src="./4102.js"></script>