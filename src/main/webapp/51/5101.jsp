        ...
        <div data-options="region:'center'">
            ...
            <table id="mainGrid"
                ...
                <tr>
                    ...
                    <th data-options="field:'hcfs',halign:'center',align:'center'" sortable="true" width="70"
                        codeName="hcfs"
                        formatter="formatCodeList">核查方式
                    </th>
                    ...
                    <th data-options="field:'hczt',halign:'center',align:'center'" sortable="true" width="100"
                        codeName="xmzt"
                        formatter="formatCodeList" styler="stylerHczt">核查状态
                    </th>
                    <th data-options="field:'hcjg',halign:'center',align:'center'" sortable="true" width="100"
                        codeName="hcjg" formatter="formatCodeList" styler="stylerHcjg">核查结果
                    </th>
            ...
            <div id="mainGridToolbar">
                ...
                <a href="#" id="btnAudit" class="easyui-linkbutton" iconCls="icon2 r5_c20" plain="true"
                   disabled>核查/查看</a>
            </div>
        </div>
    </div>
...
<div id="gaozhishuWindow" class="easyui-window" title="核查"
     data-options="modal:true,closed:true,iconCls:'icon-search'"
     style="width: 750px; height: 400px; padding: 10px;">
    <div id="gaozhishuContent" style="padding:10px;"></div>
</div>
