...
<script>
	function doSaveDoc() {
		if( $("#d_mongoId").val() == "") {
			...
			var data = $.husky.getFormData('addDocWindow');
		    ...
		    $.ajax({
		        ...
		        success: function (response) {
		            if (response.status == $.husky.SUCCESS) {
		                ...
		                $.messager.show('操作提示', "检查材料保存成功", "info", "bottomRight");
		            } else {
	...
	function doInitDocForm() {
		...
		var hcsx = $("#annualAuditItemGrid").datagrid("getSelected");
		...
		$("#d_hcsxId").combobox({url: "./js/hcsx", method:'get',valueField: 'VALUE', textField: 'LITERAL',
