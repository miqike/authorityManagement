    ...
    <!-- 
     ...
     <div data-options="region:'center'">
         ...
         <div id="grid2Toolbar">
			 ...
			 <input type="radio" name="docReadyReportFlag" id="docReadyReportFlag" value="" />全部上报
			 <input type="checkbox" id="check_excludeFinished" name="excludeFinished" checked>不包含已完成的任务
