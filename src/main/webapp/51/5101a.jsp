	    ...
	    <div class="easyui-panel" data-options="height:64, noheader:true, collapsed:false,collapsible:false," style="padding-top:5px;width:auto">
			...
			<div id="toobar2">
			    ...
			    <shiro:hasPermission name="5105:btnUpdateHcjg">
					...
					<input id="p_hcjieguo" class="easyui-combobox" data-options="width:145" codeName="gsjg" />
					<a href="javascript:void(0);" id="btnConfirmUpdateHcjg" class="easyui-linkbutton" plain="true" iconCls="icon-ok" >设置检查结果</a>
			    </shiro:hasPermission>
			</div>
		</div>
	</div>
