...
<div id="popPageRow">
    ...
    <div style="margin-left:350px;">
        ...
        <span id="deptName" style="padding: 5px;color:blue;">${user.name}</span>
...
<table id="grid1"
    ...
    <tr>
        ...
        <th data-options="field:'id'" halign="center" align="center" width="40" formatter="formatRoleInTask" rowspan="2">角色</th>
        ...
        <th data-options="field:'weightPer',halign:'center',align:'center'" width="35" rowspan="2">权重</th>
...
<script type="text/javascript" src="./personalPlan.js"></script>
