...
function focusNext(current) {
    var next = null;
    var inputElements = $("input.easyui-textbox, input.easyui-datebox, input.easyui-combobox, input.easyui-numberbox, input.easyui-numberspinner, input:checkbox, select.easyui-combobox, a.easyui-linkbutton");
