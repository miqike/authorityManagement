 ...
 */
function listPrint(params, data, columnList) {
    //参数默认值
    ...
    for (var pageNo = 1; pageNo <= pages; pageNo++) {
        ...
        if (pageTitleFirst == "1") {
            if (pageNo == 1) {
                ...
                LODOP.SET_PRINT_STYLE(0, "FontName", pageTitleFontName);
        ...
        for (var headNo = 0; headNo < columnList.length; headNo++) {
            ...
            LODOP.SET_PRINT_STYLE(0, "FontName", headFontName);
        ...
        if (pageFootLast == "1") {
            if (pageNo == pages) {
                ...
                LODOP.SET_PRINT_STYLE(0, "FontName", pageFootFontName);
