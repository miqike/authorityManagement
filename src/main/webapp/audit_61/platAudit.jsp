...
<div>
   ...
   <div class="hcsx" style="float:left;width: 70px;">检查方法：</div><div style="color:blue; " id="_auditApproach_"></div><br/>
   <table id="auditTable" class="easyui-datagrid" data-options="collapsible:true,ctrlSelect:true">
    	...
    	<tr>
            ...
            <th data-options="field:'b'" halign="center" align="center" width="135" >登记/备案内容</th>
            <th data-options="field:'c'" halign="center" align="center" width="135" >实际内容</th>
