...
<script type="text/javascript" src="../audit_61/email.js"></script>
<div>
    ...
    <table>
    	...
    	<tr> <td class="hcsx" style="color:blue">公示内容：</td><td><span style="color:blue; " id="_qygsnr_"></span></td></tr>
    	<tr> <td class="hcsx" style="color:green">登记/备案内容：</td><td><span style="color:blue; " id="_bznr_"></span></td></tr>
    	...
    	<tr> <td></td><td><a href="#" id="btnSentVerifyMail" class="easyui-linkbutton" iconCls="icon2 r10_c10" plain="true">发送验证邮件</a></td></tr>
    </table>
</div>
