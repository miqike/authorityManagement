...
<script>
    //表配置，需要给出表名和显示的列表
    var tableConfig = {tableName:"JS_HZ_GDCZ",columns:[[
        {field:"REGNO",title:"企业注册号",width:100},
        {field:"GD",title:"股东名称",width:100},
        ...
        {field:"RJCZFS",title:"认缴出资方式（名称）",width:100},
        {field:"RJCZRQ",title:"认缴出资日期",width:100,formatter:formatDate},
        {field:"RJE",title:"认缴额",width:100},
        {field:"SJCZE",title:"实缴出资额",width:100},
        {field:"SJCZFS",title:"实缴出资方式（名称）",width:100},
        {field:"SJCZRQ",title:"实缴出资日期",width:100,formatter:formatDate},
    ...
    function reset(){
        $("#panel").panel('refresh','JS_HZ_GDCZ.jsp');
    }
    $(function() {
