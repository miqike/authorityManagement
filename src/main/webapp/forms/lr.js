$(function() {
		$("#p_item15Bqfse").textbox('textbox').bind('click', function(e){
		...
		$("#p_item15Sqfse").textbox('textbox').bind('click', function(e){
			...
			$("#p_item20Bqfse").textbox('textbox').bind('click', function(e){
			...
			$("#p_item20Sqfse").textbox('textbox').bind('click', function(e){
			...
			$("#p_item22Bqfse").textbox('textbox').bind('click', function(e){
			...
			$("#p_item22Sqfse").textbox('textbox').bind('click', function(e){
			...
			$("#p_item35Bqfse").textbox('textbox').bind('click', function(e){
			...
			$("#p_item35Sqfse").textbox('textbox').bind('click', function(e){
			...
			$("#p_item36Bqfse").textbox('textbox').bind('click', function(e){
			...
			$("#p_item36Sqfse").textbox('textbox').bind('click', function(e){
			...
			$("#p_item37Bqfse").textbox('textbox').bind('click', function(e){
			...
			$("#p_item37Sqfse").textbox('textbox').bind('click', function(e){
			...
			$("#p_item40Bqfse").textbox('textbox').bind('click', function(e){
			...
			$("#p_item40Sqfse").textbox('textbox').bind('click', function(e){
			...
			$("#p_item47Bqfse").textbox('textbox').bind('click', function(e){
						var p_item22Bqfse = $("#p_item22Bqfse").val();
			...
			$("#p_item47Sqfse").textbox('textbox').bind('click', function(e){
						var p_item22Sqfse = $("#p_item22Sqfse").val();
