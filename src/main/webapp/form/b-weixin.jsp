<%@ page contentType="text/html; charset=UTF-8"%>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <input id="i_leaveType" class="form-control easyui-combobox" type="text" codeName="leaveType"  readonly/>
      </div>
    </div>
    <div class="form-group">
      <label for="i_startDate" class="col-sm-2 control-label">请假时间起</label>
      <div class="col-sm-10">
        <input id="i_startDate" class="form-control" type="date" readonly/>
      </div>
    </div>
    <div class="form-group">
      <label for="i_endDate" class="col-sm-2 control-label">请假时间止</label>
      <div class="col-sm-10">
        <input id="i_endDate" class="form-control" type="date" readonly/>
      </div>
    </div>
    <div class="form-group">
      <label for="i_reason" class="col-sm-2 control-label">事由</label>
      <div class="col-sm-10">
        <input id="i_reason" class="form-control" type="text" readonly/>
      </div>
    </div>
