      ...
      **/
      ...
      insert into t_nb(ND, XYDM, QYMC, TXDZ, MAIL, SFTZGMGQ, JYZT, SFYWZWD,
        ...
        select v_nd ND,v_zch XYDM,v_qymc QYMC, f.txdz TXDZ, f.dzyx MAIL, decode(trim(e.sfydwtz),'0','否','是') SFTZGMGQ,
               ...
               a.cyrs CYRS, c.syzqyhj SYZQYHJ, c.LRZE LRZE, c.zyywsr ZYYWSR, c.jlr JLR, c.nsze NSZE, c.fzze FZZE,p_hcrwid HCRW_ID,f.lxdh lxdh,
               e.COLGRANUM gxbys_jy, e.COLEMPLNUM  gxbys_gg, e.RETSOLNUM tysbs_jy, e.RETEMPLNUM tysbs_gg, e.DISPERNUM cjrs_jy, e.DISEMPLNUM cjrs_gg, e.UNENUM zjys_jy,
               e.UNEEMPLNUM zjys_gg,
      ...
      insert into t_nb_bd(ND, XYDM, QYMC, TXDZ, MAIL, SFTZGMGQ, JYZT, SFYWZWD,
        ...
        select v_nd ND,v_zch XYDM,v_qymc QYMC, a.dom TXDZ, a.email MAIL,
               ...
               null gxbys_jy, null  gxbys_gg, null tysbs_jy, null tysbs_gg, null cjrs_jy, null cjrs_gg, null zjys_jy, null zjys_gg,
